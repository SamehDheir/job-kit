    ...
    <section className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 px-4 md:px-20 py-16">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
        ...
        <p className="text-gray-600 leading-relaxed text-base md:text-lg">
          ...
          internationally, you can begin creating your resume in under 5 seconds.
          Additionally, you can edit it to fit your preferences and personality
          before clicking <span className="font-semibold">Download</span>. Even if
          you have never created a resume before — it’s that SIMPLE to use!
        </p>
      </div>
